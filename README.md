...
ファインチューニング済みアダプタ（43MB）は HuggingFace Hub で公開予定:

```
# 近日公開（HF Hub リポジトリ URL をここに追記）
# from huggingface_hub import snapshot_download
# snapshot_download("yamag/lfm25-audio-jp-dialect-lora-v4", local_dir="checkpoints/lora_convert_v4/best")
```

### 学習データ

加工済みデータセット（方言音声×標準語テキスト 2,600件）は HuggingFace Hub で公開予定:

```
# 近日公開（HF Hub Dataset URL をここに追記）
```
